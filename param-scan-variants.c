...
int main(void)
{
  ...
  // open file for output
  fp = fopen(fstr, "w");
  fprintf(fp, "t, pro_1, pro_2, prooff_1, prooff_2, propoff_1, propoff_2, rna_1, rna_2, p_1, p_2, pp_1, pp_2\n");
  fclose(fp);*/
	  ...
	  for(ip1 = 0; ip1 < 30; ip1 += 3)
	      ...
	      for(ip2 = 0; ip2 < 30; ip2 += 3)
		{
		  ...
		  /*
		    ...
		    {
		    fp = fopen("test-series.csv", "a");	      
		    fprintf(fp, "%.3e,%.3e,%.3e,%.3e,%.3e,%.3e,%.3e,%.3e,%.3e,%.3e,%.3e,%.3e,%.3e\n", t, pro_1, pro_2, prooff_1, prooff_2, propoff_1, propoff_2, rna_1, rna_2, p_1, p_2, pp_1, pp_2);
		    fclose(fp);
		    }*/
